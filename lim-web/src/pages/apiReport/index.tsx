...
import { Table, message, Skeleton, Tooltip, Row, Col, Card, Statistic, Spin } from 'antd';
...
import { getApiReport, treeCascaderModuleCase } from '@/services/apiData';
import './index.css';
...
const Report = (props: any) => {
  ...
  return (
    <Spin spinning={loading} tip={<p style={{ fontWeight: 'bold' }}>报告加载中...</p>}>
      <Row justify="center">
        <Col span={20}>
          {loading ? (
